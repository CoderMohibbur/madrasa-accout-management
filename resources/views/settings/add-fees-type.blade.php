            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-4 gap-10">
                        <div>
                            <form method="POST" action="{{ isset($class) ? route('add_fees_type.update', $class->id) : route('add_fees_type.store') }}">
                                @csrf
                                    ...
                                    @foreach ($classes as $class)
                                        <tr>
                                            ...
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400 text-center">
                                                ...
                                                <form action="{{ route('add_fees_type.destroy', $class->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <x-danger-button >
                                                        {{ __('Delete') }}
