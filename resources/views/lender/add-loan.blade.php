             ...
             <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                 <div class="p-6 text-gray-900 dark:text-gray-100">
                     ...
                     <form method="POST" enctype="multipart/form-data"
                         action="{{ isset($transaction) ? route('add_loan.update_loan', $transaction->id) : route('loan_store.loan_store') }}">
                         ...
                         <div class="grid grid-cols-2 gap-10">
                             ...
                             <div>
                                 <!-- Lender Amount -->
                                 <div class="mt-5">
                                     <x-input-label for="debit" :value="__('Loan Amount')" />
                                     <x-text-input id="debit" class="block mt-1 w-full" type="text"
                                         name="debit" :value="isset($transaction)
                                             ? $transaction->debit
                                             : old('debit')" required />
