...
<head>
    ...
    <title> At-Tawheed Islami Complex
    </title>
...
<body>
    ...
    <nav class="bg-white border-gray-50 dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4"> <!-- Increased padding -->
            <a href="https://attawheedic.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                {{-- <img src="/img/logo image.png" class="h-20 w-20" alt="Flowbite Logo" /> <!-- Increased logo size --> --}}
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">At-Tawheed</span>
            </a>
            ...
            <div id="mega-menu" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                    ...
                    <li>
                        <a href="https://attawheedic.com/admission/"
                            class="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Admission</a>
                    </li>
                    <li>
                        <a href="https://attawheedic.com/about/"
                    ...
                    <li>
                        <a href="https://attawheedic.com/contact/"
                    ...
                    <li>
                        <a href="https://attawheedic.com/donation/"
                            class="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Donate</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="relative h-screen">
        <!-- Background Image in HD -->
        <img src="/img/background image.png" alt="Registan Square, Uzbekistan" class="w-full h-full object-cover">

        <!-- Text on top of the image -->
        <div class="absolute inset-x-0 top-1/4 text-center space-y-4">
            <h1 class="text-5xl lg:text-6xl font-extrabold text-white drop-shadow-lg">
                At-Tawheed Islami Complex </h1>
            <h2 class="text-3xl lg:text-4xl font-semibold text-yellow-300 drop-shadow-md">
                পুলেরহাট, সদর, যশোর
        ...
        <div class="py-4 bg-gray-800 dark:bg-gray-700">
            <div class="container mx-auto flex flex-wrap justify-between items-center">
                ...
                <ul class="flex space-x-4">
                    <li>
                        <a href="https://www.facebook.com/AtTawheedIslamiComplex/" target="_blank"
                    ...
                    <li>
                        <a href="https://www.youtube.com/@AtTawheedIslamiComplex" target="_blank"
                            class="text-gray-300 hover:text-blue-500 transition">
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a href="https://attawheedic.com/" target="_blank"
                            class="text-gray-300 hover:text-blue-500 transition">
