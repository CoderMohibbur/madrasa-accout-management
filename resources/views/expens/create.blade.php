            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" enctype="multipart/form-data"
                        action="{{ isset($Expen) ? route('expens.update', $Expen->id) : route('expens.store') }}">
                            ...
                            <div>
                                ...
                                <div class="mt-5">
                                    ...
                                    <select id="isActived" name="isActived" class="block mt-1 w-full">
                                        <option value="1"
                                            {{ isset($Expen) && $Expen->isActived ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0"
                                            {{ isset($Expen) && !$Expen->isActived ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
