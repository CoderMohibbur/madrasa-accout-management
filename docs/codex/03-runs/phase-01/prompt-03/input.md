...
- Apply prompt-01 guardrails and prompt-02 live inventory as fixed inputs.
- Freeze the target business rules without assuming the current repository already satisfies every requested requirement.
- Where the broader codex requirements exceed the narrower already-implemented repo state, record them as frozen target rules or later-phase requirements instead of silently treating them as already delivered.
...
Additional read set used to freeze rules against the live repository and codex context:
- docs/codex/02-context/business-rules.md
- docs/codex/02-context/guest-donation-requirements.md
- docs/codex/02-context/guardian-informational-portal-requirements.md
- docs/codex/02-context/multi-role-rules.md
- docs/codex/02-context/ui-ux-requirements.md
- docs/codex/03-runs/phase-00/prompt-01/report.md
